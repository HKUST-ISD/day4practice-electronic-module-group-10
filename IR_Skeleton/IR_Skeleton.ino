...
#define SENSOR_AO_PIN 4 // ESP32 pin connected to AO pin of IR sensor
...
void loop() {
    ...
    */
    ...
    if (state == LOW){
        ...
        Serial.println("Obsitical is presented");
    ...
    delay(200); // Delay 0.1s to avoid reading the state too fast

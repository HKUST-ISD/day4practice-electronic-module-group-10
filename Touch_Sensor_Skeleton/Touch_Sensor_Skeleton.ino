...
#define LED 2                         // ***Replace the ? with the GPIO pin you selected to control LED
#define THRESHOLD 35000               // ***Observe the reading when the pin is touched. Then modify this threshold.***
